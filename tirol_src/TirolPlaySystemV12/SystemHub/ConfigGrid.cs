...
namespace XControls.UI
{
    ...
    public class ConfigGrid : PropertyGrid
    {
        ...
        public class ItemSetting
        {
            ...
            /// <summary>
            /// この項目のタイプを参照したり設定します。特殊なタイプとして"Folder","FullFolder","IPAddress","Password"が使用できます。
            /// </summary>
            [
                Category("設定"),
                DefaultValue("string"),
                Description("この項目のタイプを参照したり設定します。特殊なタイプとして\"Folder\",\"FullFolder\",\"IPAddress\",\"Password\"が使用できます。")
            ]
        ...
        internal class ConfigDataTypeEditor : System.Drawing.Design.UITypeEditor
        {
            ...
            {
                if (valtype == "folder" || valtype == "fullfolder" || valtype == "password")
                {
                    // [...]を表示
