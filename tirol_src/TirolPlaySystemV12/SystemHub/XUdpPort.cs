...
namespace XControls
{
    ...
    /// シリアル通信を行うためのクラスです。
    /// </summary>
    [Designer(typeof(XComPortDesigner))]
    public class UDPPort : UserControl
    {
        #region インナークラス

        #region XComPortDesignerクラス

        /// <summary>
        /// XConfig用にデザイナをカスタマイズします。
        /// </summary>
        public class XComPortDesigner : System.Windows.Forms.Design.ControlDesigner
        {
            #region 構築・破棄

            /// <summary>
            /// XControls.XConfig.XComPortDesigner クラスの新しいインスタンスを初期化します。
            /// </summary>
            public XComPortDesigner()
            {
            }
        ...
        /// <summary>
        /// XControls.XComPort クラスの新しいインスタンスを初期化します。
        /// </summary>
        public XComPort()
        {
            #region コンポーネント初期化
        ...
        /// <param name="e">イベントデータ</param>
        private void backColors_ColorChange(object sender, XComPort.BackColors.ColorChangeEventArgs e)
        {
            if (comPort.IsOpen == true)
            {
                labelRecive.BackColor = backColors.ReciveOff;
